		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12 col-lg-12">
					<ol class="breadcrumb">
						<li><a href="#">Home</a></li>
						<li class="active">${param.community_name}</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="page-header">
					<h2 id="container">클럽 멤버 탈퇴하기</h2>
				</div>
				<div class="well">
					<form class="form-horizontal" action="${ctx}/club/withdrawal.do"
						method="post">
